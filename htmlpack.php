	...
	<head>
		...
		<body>	
		  <header id="header">
			...
			<!-- Start services Area -->
			<section id="section1" class="services-area section-gap" style="background-image: url(images/middle.png);background-size: cover;background-repeat: no-repeat;">
				<div class="container">
			...
			<!-- FOSS Copyrighted -->	
			<section class="facts-area section-gap" id="facts-area" style="padding: 40px;" >
				<div class="container">				
					<div class="row">
		    ...
		    <section id="section2" class="timeline pb-120">
